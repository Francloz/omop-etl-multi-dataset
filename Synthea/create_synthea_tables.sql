...
--HINT DISTRIBUTE_ON_RANDOM
create table native.conditions (
"start"         date,
stop          date,
patient       varchar(1000),
encounter     varchar(1000),
...
--HINT DISTRIBUTE_ON_RANDOM
create table native.encounters (
id            		varchar(1000),
"start"         		date,
stop							date,
patient       		varchar(1000),
...
--HINT DISTRIBUTE_ON_RANDOM
create table native.immunizations (
"date"        date,
patient       varchar(1000),
encounter     varchar(1000),
code          varchar(100),
...
--HINT DISTRIBUTE_ON_RANDOM
create table native.imaging_studies (
id			  varchar(1000),
"date"        date,
patient					varchar(1000),
encounter				varchar(1000),
...
--HINT DISTRIBUTE_ON_RANDOM
create table native.medications (
"start"         date,
stop          date,
patient       varchar(1000),
payer		varchar(1000),
...
--HINT DISTRIBUTE_ON_RANDOM
create table native.observations (
"date"         date,
patient       varchar(1000),
encounter     varchar(1000),
...
--HINT DISTRIBUTE_ON_RANDOM
create table native.organizations (
id			  varchar(1000),
"name"	      varchar(1000),
...
--HINT DISTRIBUTE_ON_RANDOM
create table native.procedures (
"start"         date,
stop          date,
patient       varchar(1000),
encounter     varchar(1000),
...
--HINT DISTRIBUTE_ON_RANDOM
create table native.claims_transactions (
  id                     varchar(1000),
...
--HINT DISTRIBUTE_ON_RANDOM
create table native.payer_transitions (
 patient           varchar(1000),
